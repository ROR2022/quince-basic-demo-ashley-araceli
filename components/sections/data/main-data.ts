export const quinceMainData = {
  ...
  event: {
    celebrant: "Ashley Araceli",
    //Padres María de Jesús Gutiérrez y Andres Ramírez
    parents: {
      father: "Omar Molina",
      mother: "Griselda Alvarado",
    ...
    godparents: {
      godfather: "Donaciana Equihua",
      godmother: "Wuilivaldo Mercado",
    },
    abuelos:{
      maternos: {
        abuelo: "Macario",
  ...
  attendance: {
    whatsappNumber: "5214251309088", // +52 1 425 130 9088
    ...
    images: [
      {
        ...
        alt: "Ashley Araceli en sus XV años",
        caption: "Ashley Araceli radiante en su día especial.",
      },
      {
        id: "image2",
        src: "/images/rapunzel2.jpeg",
        alt: "Baile de Quinceañera",
        caption: "El emotivo primer baile de Ashley Araceli.",
      },
      {
        id: "image3",
      ...
      },
      {
        ...
        caption: "Ashley Araceli rodeada de sus seres queridos.",
      },
      {
        id: "image5",
      ...
      },
      {
        ...
        alt: "Ashley Araceli y sus Padres",
  ...
  customInvitations:{
    ...
    invitationUrl: "https://quince-vip-Ashley Araceli.vercel.app/",
    suggested_messages: [
