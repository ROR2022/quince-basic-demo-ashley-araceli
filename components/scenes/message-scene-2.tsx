...
export function MessageScene2({ onComplete, isActive }: MessageScene2Props) {
  ...
  const secondMessage = event.parents.father
  const thirdMessage = event.parents.mother
  const fourthMessage = "Mis Padrinos"
  const fifthMessage = event.godparents.godfather
  const sixthMessage = event.godparents.godmother
