...
export function MessageScene3({ onComplete, isActive = true }: MessageScene3Props) {
  ...
  const secondMessage = event.ceremony.venue
  const thirdMessage = event.ceremony.time
  const fourthMessage = event.ceremony.address
  const fifthMessage = event.ceremony.type
  const ubiLink = event.ceremony.ubiLink
            ...
            {showContent && (
              <div className="mb-8">
                <TypewriterText 
                  text={firstMessage}
                  delay={100}
                  className="text-6xl md:text-8xl font-bold text-pink-800 font-main-text leading-tight"
            ...
            {firstTextComplete && (
              <div className="mb-6">
                <TypewriterText 
                  text={secondMessage}
                  delay={80}
                  className="text-4xl md:text-3xl text-pink-600 font-main-text"
            ...
            {secondTextComplete && (
              <div className="mb-6">
                <TypewriterText 
                  text={thirdMessage}
                  delay={100}
                  className="text-4xl md:text-4xl font-bold text-pink-800 font-main-text"
            ...
            {thirdTextComplete && (
              <div className="mb-6">
                <TypewriterText 
                  text={fourthMessage}
                  delay={60}
                  className="text-4xl md:text-xl text-pink-600 font-main-text leading-relaxed"
            ...
            {fourthTextComplete && (
              <div className="mb-8">
                <TypewriterText 
                  text={fifthMessage}
                  delay={80}
                  className="text-4xl md:text-3xl text-pink-800 font-main-text italic"
